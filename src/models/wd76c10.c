...
uint16_t wd76c10_read(uint16_t port, void *priv) {
	switch (port) {
	case 0x0092:return wd76c10_0092;

	case 0x2072:return wd76c10_2072;

	case 0x2872:return wd76c10_2872;

	case 0x5872:return wd76c10_5872;

	case 0x6072:return wd76c10_6072;
	}
	return 0;
}
...
void wd76c10_write(uint16_t port, uint16_t val, void *priv) {
	...
	switch (port) {
	case 0x0092:wd76c10_0092 = val;

		mem_a20_alt = val & 2;
		mem_a20_recalc();
		break;

	case 0x2072:wd76c10_2072 = val;

		serial1_remove();
		if (!(val & 0x10)) {
			switch ((val >> 5) & 7) {
			case 1: serial1_set(0x3f8, 4);
				break;
			case 2: serial1_set(0x2f8, 4);
				break;
			case 3: serial1_set(0x3e8, 4);
				break;
			case 4: serial1_set(0x2e8, 4);
				break;
			default: serial1_remove();
				break;
			}
		}
		serial2_remove();
		if (!(val & 0x01)) {
			switch ((val >> 1) & 7) {
			case 1: serial2_set(0x3f8, 3);
				break;
			case 2: serial2_set(0x2f8, 3);
				break;
			case 3: serial2_set(0x3e8, 3);
				break;
			case 4: serial2_set(0x2e8, 3);
				break;
			default: serial2_remove();
				break;
			}
		}
		break;

	case 0x2872:wd76c10_2872 = val;
	...
	case 0x5872:wd76c10_5872 = val;
		break;

	case 0x6072:wd76c10_6072 = val;
		break;
	}
}
