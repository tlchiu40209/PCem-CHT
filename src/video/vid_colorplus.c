                ...
                else if (colorplus->cga.sc == colorplus->cga.crtc[9])
                {
                        ...
                        if (colorplus->cga.vc == colorplus->cga.crtc[7])
                        {
                                ...
                                if (colorplus->cga.crtc[7])
                                {
                                        ...
                                        video_blit_memtoscreen(0,
                                                colorplus->cga.firstline - 4, 0,
                                                (colorplus->cga.lastline - colorplus->cga.firstline) + 8, xsize, (colorplus->cga.lastline - colorplus->cga.firstline) + 8);
                                        frames++;
