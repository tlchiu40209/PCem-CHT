...
void wy700_out(uint16_t addr, uint8_t val, void *p) {
	...
	case 0x3d2:
	case 0x3d4:
	case 0x3d6:wy700->cga_crtcreg = val & 31;
		break;
	...
	case 0x3d3:
	case 0x3d5:
	case 0x3d7:wy700->cga_crtc[wy700->cga_crtcreg] = val;
	...
	case 0x3b8:
	case 0x3D8:wy700->cga_ctrl = val;
		wy700_checkchanges(wy700);
		return;
		/* Emulated CGA colour register */
	case 0x3D9:wy700->cga_colour = val;
		return;
	}
}
...
uint8_t wy700_in(uint16_t addr, void *p) {
	...
	case 0x3d2:
	case 0x3d4:
	case 0x3d6:return wy700->cga_crtcreg;
	case 0x3b1:
	case 0x3b3:
	case 0x3b5:
	case 0x3b7:
	...
	case 0x3d3:
	case 0x3d5:
	case 0x3d7:return wy700->cga_crtc[wy700->cga_crtcreg];
	case 0x3b8:
	case 0x3d8:return wy700->cga_ctrl;
	case 0x3d9:return wy700->cga_colour;
	case 0x3ba:return wy700->mda_stat;
	case 0x3da:return wy700->cga_stat;
	}
	return 0xff;
}
...
void wy700_poll(void *p) {
	...
	if (!wy700->linepos) {
		...
		if (wy700->dispon) {
			...
			default:
			case 0x00:
			case 0x02:wy700_textline(wy700);
				break;
			case 0x04:
			case 0x06:wy700_cgaline(wy700);
				break;
			case 0x80:
			case 0x90:wy700_medresline(wy700);
				break;
			case 0xA0:
			case 0xB0:
			case 0xC0:
			case 0xD0:
			case 0xE0:
			case 0xF0:wy700_hiresline(wy700);
				break;
			}
		}
		wy700->displine++;
...
/* Hardcode 1280x800 window size */
			...
			switch (mode) {
			case 0x00:
			case 0x02:video_bpp = 0;
				break;
			case 0x04:
			case 0x90:
			case 0xB0:
			case 0xD0:
			case 0xF0:video_bpp = 2;
				break;
			default:video_bpp = 1;
				break;
			}
