...
UINT16 convert_scan_code(UINT16 scan_code) {
	switch (scan_code) {
	case 0xE001:return 0xF001;
	case 0xE002:return 0xF002;
	case 0xE005:return 0xF005;
	case 0xE006:return 0xF006;
	case 0xE007:return 0xF007;
	case 0xE071:return 0xF008;
	case 0xE072:return 0xF009;
	case 0xE07F:return 0xF00A;
	case 0xE0E1:return 0xF00B;
	case 0xE0EE:return 0xF00C;
	case 0xE0F1:return 0xF00D;
	case 0xE0FE:return 0xF00E;
	case 0xE0EF:return 0xF00F;
...
LRESULT CALLBACK WindowProcedure(HWND hwnd, UINT message, WPARAM wParam, LPARAM lParam) {
	...
	case WM_INPUT: {
		...
		break;
	case WM_SETFOCUS:infocus = 1;
		break;
	case WM_KILLFOCUS:infocus = 0;
		if (is_fullscreen())
			window_dowindowed = 1;
...
int window_create() {
	...
	if (!window) {
		...
		sprintf(message,
			"無法建立 SDL 視窗介面! 原因: %s\n",
			SDL_GetError());
		wx_messagebox(window_ptr, message, "SDL 錯誤", WX_MB_OK);
		return 0;
	}
