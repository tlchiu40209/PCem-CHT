...
/*        if (val == 0x1c)
	...
	if (romset == ROM_T3100E && (pcem_key[0xb8] || pcem_key[0x9d])) {
		switch (val) {
		case 0x4f: t3100e_notify_set(0x01);
			break; /* End */
		case 0x50: t3100e_notify_set(0x02);
			break; /* Down */
		case 0x51: t3100e_notify_set(0x03);
			break; /* PgDn */
		case 0x52: t3100e_notify_set(0x04);
			break; /* Ins */
		case 0x53: t3100e_notify_set(0x05);
			break; /* Del */
		case 0x54: t3100e_notify_set(0x06);
			break; /* SysRQ */
		case 0x45: t3100e_notify_set(0x07);
			break; /* NumLock */
		case 0x46: t3100e_notify_set(0x08);
			break; /* ScrLock */
		case 0x47: t3100e_notify_set(0x09);
			break; /* Home */
		case 0x48: t3100e_notify_set(0x0A);
			break; /* Up */
		case 0x49: t3100e_notify_set(0x0B);
			break; /* PgUp */
		case 0x4A: t3100e_notify_set(0x0C);
			break; /* Keypad -*/
		case 0x4B: t3100e_notify_set(0x0D);
			break; /* Left */
		case 0x4C: t3100e_notify_set(0x0E);
			break; /* KP 5 */
		case 0x4D: t3100e_notify_set(0x0F);
			break; /* Right */
		}
	}
...
/*        if (ram[8] == 0xc3) 
	...
	case 0x60:
		if (keyboard_at.want60) {
			...
			case 0x7d:
			case 0x7e:
			case 0x7f:keyboard_at.mem[keyboard_at.command & 0x1f] = val;
...
//                                        pclog("Rammask change to %08X %02X\n", rammask, val & 0x02);
			...
			default:pclog("Bad AT keyboard controller 0060 write %02X command %02X\n", val, keyboard_at.command);
//                                dumpregs();
//                                exit(-1);
			}
		} else {
			...
			if (keyboard_at.key_wantdata) {
				...
				case 0xf0: /*Set scancode set*/
					...
					case 0: /*Read current set*/
						...
						case SCANCODE_SET_1:keyboard_at_adddata_keyboard(0x01);
							break;
						case SCANCODE_SET_2:keyboard_at_adddata_keyboard(0x02);
							break;
						case SCANCODE_SET_3:keyboard_at_adddata_keyboard(0x03);
							break;
						}
						break;
					case 1:keyboard_at.scancode_set = SCANCODE_SET_1;
						keyboard_set_scancode_set(SCANCODE_SET_1);
						keyboard_at_adddata_keyboard(0xfa);
						break;
					case 2:keyboard_at.scancode_set = SCANCODE_SET_2;
						keyboard_set_scancode_set(SCANCODE_SET_2);
						keyboard_at_adddata_keyboard(0xfa);
						break;
					case 3:keyboard_at.scancode_set = SCANCODE_SET_3;
						keyboard_set_scancode_set(SCANCODE_SET_3);
						keyboard_at_adddata_keyboard(0xfa);
						break;
					default:keyboard_at_adddata_keyboard(0xfe);
						break;
					}
					break;
				...
				default:pclog("Bad AT keyboard 0060 write %02X command %02X\n", val, keyboard_at.key_command);
//                                        dumpregs();
//                                        exit(-1);
				}
			} else {
				...
				default:pclog("Bad AT keyboard command %02X\n", val);
					keyboard_at_adddata_keyboard(0xfe);
//                                        dumpregs();
//                                        exit(-1);
				}
	...
	case 0x64:keyboard_at.want60 = 0;
		...
		case 0x3d:
		case 0x3e:
		case 0x3f:keyboard_at_adddata(keyboard_at.mem[val & 0x1f]);
			break;
		...
		case 0x7d:
		case 0x7e:
		case 0x7f:keyboard_at.want60 = 1;
			break;
...
//                                pclog("Rammask change to %08X %02X\n", rammask, val & 0x02);
		...
		default:pclog("Bad AT keyboard controller command %02X\n", val);
//                        dumpregs();
//                        exit(-1);
		}
	}
...
//        if (port != 0x61) pclog("keyboard_at : read %04X ", port);
	...
	case 0x64:temp = keyboard_at.status & ~4;
